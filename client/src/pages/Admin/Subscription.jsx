...
const SubscriptionDashboard = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.limit || Number.parseInt(formData.limit) < 0) errors.limit = "Valid limit is required"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        await axios.post(`${BASE_URL}/subscription/edit/${selectedSubscription._id}`, submitData)
        // Update local state
        setSubscriptions((prev) =>
          prev.map((sub) => (sub._id === selectedSubscription._id ? { ...sub, ...submitData } : sub)),
        )
      } else {
        const response = await axios.post(`${BASE_URL}/subscription/maincreate`, submitData)
        // Add to local state
      ...
      alert(isEditing ? "Subscription updated successfully!" : "Subscription created successfully!")
    } catch (error) {
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      ...
                      <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <p className="text-2xl font-bold text-green-600">{subscription.limit}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <span className="text-sm font-medium text-gray-600">Meeting Limit:</span>
                      <p className="text-gray-800">{selectedSubscription.limit} per meeting</p>
                    </div>
                  </div>
                </div>
